/* =====================================================================
/FarmVista-Beta/js/shop-equipment-modal.js  (FULL FILE)
Rev: 2026-03-05b
Updates (per Dane):
...
#svcSheet .fv-fr-pill.on{
  ...
  async function ensureWoModalLoaded(){
    ...
    state.woModuleLoading = (async ()=>{
      try{
        const mod = await import("/FarmVista-Beta/js/shop-equipment-wo-modal.js");
        state.woModule = mod || {};
...
/* ===== End ===== */
  ...
  async function ensureEquipmentFormsLoaded(){
    ...
    ensureEquipmentFormsLoaded._loading = new Promise((resolve)=>{
      ...
      s.src = "/FarmVista-Beta/js/equipment-forms.js";
      s.defer = true;
      s.onload = ()=> resolve();
      s.onerror = ()=> resolve();
