...
(function (global, doc) {
  ...
  function loadPageGuards(){
    try{
      ...
      if (path.endsWith('/FarmVista-Beta/pages/grain/grain-ticket.html') && !doc.querySelector('script[data-fv-grain-warning-guard]')) {
        ...
        script.src = '/FarmVista-Beta/js/grain-ticket-dashboard-warning-patch.js?v=20260911-2';
        script.defer = true;
  ...
  function loadHaulingJobUx(){
    try{
      ...
      if (!doc.querySelector('script[data-fv-hauling-job-ux]')) {
        const script = doc.createElement('script');
        script.src = '/FarmVista-Beta/js/grain-hauling-job-ux.js?v=20260911-2';
        script.defer = true;
      ...
      if (!doc.querySelector('script[data-fv-hauling-job-dnd-guard]')) {
        ...
        guard.src = '/FarmVista-Beta/js/grain-hauling-job-dnd-guard.js?v=20260911-1';
        guard.defer = true;
  ...
  function loadGrainIndexHaulingJobs(){
    try{
      ...
      const script = doc.createElement('script');
      script.type = 'module';
      script.src = '/FarmVista-Beta/js/grain-index-hauling-jobs.js?v=20260913-1';
