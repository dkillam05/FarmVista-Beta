...
(function () {
  ...
  if (!window.__FV_AUTO_UPDATE_LOADER_20260908) {
    ...
    updateScript.src = '/FarmVista-Beta/js/fv-auto-update.js?v=20260908-1';
  ...
  if (
    ...
    script.type = 'module';
    script.src = '/FarmVista-Beta/js/grain-ticket-source-normalizer.js?v=20260904-3';
  ...
  if (
    ...
    const script = document.createElement('script');
    script.type = 'module';
    script.src = '/FarmVista-Beta/js/grain-source-ui-consistency.js?v=20260904-1';
  ...
  if (isGrainTicketDetail && !window.__FV_GRAIN_TICKET_SOURCE_UI_20260903) {
    ...
    const script = document.createElement('script');
    script.type = 'module';
    script.src = '/FarmVista-Beta/js/grain-ticket-detail-source-ui.js?v=20260911-4';
  ...
  if (
    ...
    const script = document.createElement('script');
    script.src = '/FarmVista-Beta/js/grain-ticket-detail-preserve-load.js?v=20260911-3';
  ...
  if (isGrainTicketPage && !window.__FV_GRAIN_LOADOUT_REPEAT_ORDER_FIX_20260903) {
    ...
    const script = document.createElement('script');
    script.type = 'module';
    script.src = '/FarmVista-Beta/js/grain-loadout-repeat-order-fix.js';
  ...
  if (isGrainTicketPage && !window.__FV_GRAIN_LOADOUT_DRIVER_JOB_RESET_LOADER_20260904) {
    ...
    const script = document.createElement('script');
    script.src = '/FarmVista-Beta/js/grain-loadout-driver-job-reset.js';
  ...
  if (isGrainTicketScan && !window.__FV_ADM_DECATUR_GRADE_FIX_LOADER_20260904) {
    ...
    const script = document.createElement('script');
    script.src = '/FarmVista-Beta/js/grain-ticket-adm-decatur-grade-fix.js?v=20260916-10';
  ...
  if (isGrainTicketScan && !window.__FV_GRAIN_TICKET_SCAN_SOURCE_FLOW_20260904) {
    ...
    const script = document.createElement('script');
    script.type = 'module';
    script.src = '/FarmVista-Beta/js/grain-ticket-scan-source-flow.js?v=20260904-2';
  ...
  if (
    ...
    const script = document.createElement('script');
    script.src = '/FarmVista-Beta/js/grain-hauling-jobs-sold-under-display.js?v=20260904-1';
  ...
  if (
    ...
    const script = document.createElement('script');
    script.src = '/FarmVista-Beta/js/grain-mobile-dnd-autoscroll.js?v=20260911-2';
  ...
  if (
    ...
    const script = document.createElement('script');
    script.src = '/FarmVista-Beta/js/grain-inventory-ticket-zoom.js?v=20260905-1';
