...
(() => {
  ...
  core.src = '/FarmVista-Beta/js/grain-mobile-dnd-autoscroll-core.js?v=20260911-1';
  ...
  async function loadData(force = false) {
    ...
    state.loading = import('/FarmVista-Beta/js/firebase-init.js').then(async firebase => {
