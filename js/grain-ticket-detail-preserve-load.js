...
(() => {
  ...
  script.src = '/FarmVista-Beta/js/grain-ticket-detail-mobile-viewer-v2.js?v=20260911-6';
  script.dataset.fvTicketDetailMobileViewer = '1';
  document.head.appendChild(script);

  const firstLoadWake = document.createElement('script');
  firstLoadWake.src = '/FarmVista-Beta/js/grain-ticket-detail-first-load-wake.js?v=20260911-3';
